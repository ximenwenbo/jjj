<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"F:\www\jjj\public/../application/admin\view\user\index.html";i:1536300859;s:47:"F:\www\jjj\application\admin\view\pub\head.html";i:1536664669;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加运动员','<?php echo url('tianjia'); ?>','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加运动员</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <td><?php echo $v['hand']; ?></td>
                <td><?php echo $v['play']; ?></td>
                <td><img src="<?php echo substr($v['image'],1); ?>" height="30"  width="120"/></td>
