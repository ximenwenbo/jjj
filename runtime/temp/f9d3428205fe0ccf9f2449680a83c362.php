<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\www\jjj\public/../application/home\view\index\index.html";i:1536829248;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <!-- 引入Layui样式 -->
     <link rel="stylesheet" href="<?php echo config('home_css'); ?>layui.css" media="all">
    <link rel="stylesheet" href="<?php echo config('home_css'); ?>index.css">
</head>
<body>
    <!-- 导航模块 开始 -->
        ...
        <div class="layui-row">
            <div class="layui-col-xs8">
                <div class="layui-col-xs6">
                    <a href="/">
                        <img src="<?php echo config('home_picture'); ?>logo_bjtydx.png" alt="">
                    </a>
                </div>
                <div class="layui-col-xs6">
                    <a href="/">
                        <img src="<?php echo config('home_picture'); ?>ittf_logo.png" alt="">
                    </a>
                </div>
            </div>
   ...
   <!-- 轮播模块 开始 -->
    <div class="layui-carousel" id="lunbo1">
        <div carousel-item>
            <div class="lunbo">
                <img src="<?php echo config('home_picture'); ?>banner_1.jpg" alt="">
            </div>
            <div class="lunbo">
                <img src="<?php echo config('home_picture'); ?>banner_1.jpg" alt="">
            </div>
                ...
                <div class="demoTable" >
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="game_name" lay-verify="" lay-search id="demoReload1">
                            ...
                            <option value="<?php echo $v['game_name']; ?>"><?php echo $v['game_name']; ?></option>
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="user_a" lay-verify=""lay-search id="demoReload3">
                            <option value="">运动员A </option>
                            <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $user[$v['user_a']]; ?>"><?php echo $user[$v['user_a']]; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>

                        </select>
                    </div>
                    <div class="layui-inline layui-col-xs3">
                        <select name="user_b" lay-verify=""lay-search id="demoReload4">
                            <option value="">运动员B</option>
                            <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $user[$v['user_b']]; ?>"><?php echo $user[$v['user_b']]; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="play" lay-verify=""lay-search id="demoReload6">
                            ...
                            <option value="两面弧圈">两面弧圈</option>
                            <option value="弧圈结合快攻">弧圈结合快攻</option>
                            <option value="削球">削球</option>
                    ...
                    <div class="layui-inline layui-col-xs3">
                        <select name="bat" lay-verify=""lay-search id="demoReload7">
                            ...
                            <option value="横">横拍</option>
                            <option value="直">直拍</option>

                        </select>
                    </div>
                    <div class="layui-inline layui-col-xs3">
                        <select name="gama_stage" lay-verify="" lay-search id="demoReload8">
    ...
    <!-- 让IE8/9支持媒体查询，从而兼容栅格 -->
    <!--[if lt IE 9]>
      <script src="<?php echo config('home_js'); ?>html5.min.js"></script>
      <script src="<?php echo config('home_js'); ?>respond.min.js"></script>
    <![endif]-->
      <!-- 引入Layui 脚本 -->
    <script src="<?php echo config('home_js'); ?>jquery.js"></script>
    <script src="<?php echo config('plugin'); ?>layui/layui.all.js"></script>
    <script>
