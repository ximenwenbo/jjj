<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\www\jjj\public/../application/admin\view\index\index.html";i:1536577456;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="/admin/user/index" data-title="资讯管理" href="javascript:void(0)">运动员列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					<li><a data-href="/admin/message/index" data-title="信息管理" href="javascript:void(0)">比赛管理</a></li>
					<li><a data-href="/admin/data/index" data-title="数据管理" href="javascript:void(0)">数据管理</a></li>
					<li><a data-href="/admin/data/down" data-title="数据下载与上传管理" href="javascript:void(0)">数据上传下载管理</a></li>
					<li><a data-href="/admin/data/score" data-title="比赛成绩" href="javascript:void(0)">比赛成绩</a></li>
				</ul>
			</dd>
		</dl>
