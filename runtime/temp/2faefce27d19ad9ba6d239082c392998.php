<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\www\php68\public/../application/admin\view\index\index.html";i:1532349736;s:49:"F:\www\php68\application\admin\view\pub\head.html";i:1532091344;s:49:"F:\www\php68\application\admin\view\pub\foot.html";i:1532090900;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
				...
				<ul class="cl">
					...
					<li class="dropDown dropDown_hover">
						...
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="#">切换账户</a></li>
							<li><span style="color:black;cursor:pointer;" onclick="layer.confirm('确认要退出系统么',{icon:6},function(){window.location.href='/admin/manager/logout';})">退出</span></li>
						</ul>
					</li>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/<?php echo $vv['ps_c']; ?>/<?php echo $vv['ps_a']; ?>"
						   data-title="<?php echo $vv['ps_name']; ?>" href="javascript:void(0)"><?php echo $vv['ps_name']; ?></a></li>
