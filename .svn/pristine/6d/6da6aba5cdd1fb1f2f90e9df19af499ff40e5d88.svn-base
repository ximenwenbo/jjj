<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\www\php68\public/../application/home\view\index\index.html";i:1534232714;s:48:"E:\www\php68\application\home\view\pub\head.html";i:1535290080;s:48:"E:\www\php68\application\home\view\pub\foot.html";i:1533952410;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="content">
			<ul>
				<li style="display:block;">
					<?php if(is_array($hot_infos) || $hot_infos instanceof \think\Collection || $hot_infos instanceof \think\Paginator): $i = 0; $__LIST__ = $hot_infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<div class="img-item">
						<p class="tab-pic">
							<span><a href="<?php echo url('goods/detail',['goods_id'=>$v['goods_id']]); ?>"
									 target="_blank">
								<img src="<?php echo substr($v['goods_logo'],1); ?>"/></a></span>
						</p>
						<div class="tab-info">
				...
				<li>
					<?php if(is_array($pro_infos) || $pro_infos instanceof \think\Collection || $pro_infos instanceof \think\Paginator): $i = 0; $__LIST__ = $pro_infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<div class="img-item">
						<p class="tab-pic">
							<span><a href="<?php echo url('goods/detail',['goods_id'=>$v['goods_id']]); ?>"
									 target="_blank">
				...
				<li>
					<?php if(is_array($new_infos) || $new_infos instanceof \think\Collection || $new_infos instanceof \think\Paginator): $i = 0; $__LIST__ = $new_infos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
					<div class="img-item">
						<p class="tab-pic">
							<span><a href="<?php echo url('goods/detail',['goods_id'=>$v['goods_id']]); ?>"
									 target="_blank">
