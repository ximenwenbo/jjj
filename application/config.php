...
return [
    ...
    // +----------------------------------------------------------------------
    'seckill'=>[
        'ids' => 'sk_goods_ids',  //秒杀商品goods_id 集合key
        'info'=>'sk_goods_info_', //单个秒杀商品信息存储key
        'num'=>'sk_goods_num_',    // 单个秒杀商品的数量key
    ],
    'mail'=>[
        'driver'          => 'smtp', // 邮件驱动, 支持 smtp|sendmail|mail 三种驱动
        'host'            => 'smtp.sina.com', // SMTP服务器地址
        'port'            => 465, // SMTP服务器端口号,一般为25
        'addr'            => 'lanyanwangdachui@sina.com', // 发件邮箱地址(邮箱帐号名称)
        'pass'            => '2534305781', // 发件邮箱密码(帐号密码)
   ...
   'special_goods'=>[
    ...
    'home_img'             =>'/home/img/',
     'home_js'             =>'/home/js/',
    'extend_css'              =>'/extend/css/',
    'extend_img'             =>'/extend/img/',
    'extend_js'             =>'/extend/js/',
